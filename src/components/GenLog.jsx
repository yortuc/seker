export default function GenLog({ sessions }) {
  ...
  return (
    <aside className="w-80 flex-shrink-0">
      <div className="text-[10px] text-zinc-600 light:text-zinc-500 font-mono uppercase tracking-widest mb-2 px-1">
        Generation Log
      </div>
...
function SessionCard({ session }) {
  ...
  return (
    <div className="bg-zinc-900 light:bg-zinc-50 border border-zinc-800 light:border-zinc-200 rounded-xl p-3 font-mono text-xs flex flex-col gap-2">
      ...
      {analysis && (
        <div className="pl-3 border-l border-zinc-800 flex flex-col gap-0.5">
          <span className="text-zinc-600 light:text-zinc-500">analysis</span>
          {analysis.genre_primary && (
            <div className="text-zinc-300 light:text-zinc-700">
              <span className="text-zinc-600 light:text-zinc-500">genre </span>
          ...
          {analysis.key && (
            <div className="text-zinc-300 light:text-zinc-700">
              <span className="text-zinc-600 light:text-zinc-500">key </span>
          ...
          {analysis.compositional_techniques?.length > 0 && (
            <div className="mt-0.5">
              <div className="text-zinc-600 light:text-zinc-500">techniques</div>
          ...
          {analysis.strudel_functions_needed?.length > 0 && (
            <div className="text-zinc-600 light:text-zinc-500">
      ...
      {code && (
        <div className="pl-3 border-l border-zinc-800 light:border-zinc-200">
...
function Row({ label, dim, children }) {
  return (
    <div className="pl-3 border-l border-zinc-800 light:border-zinc-200">
      {label && <div className="text-zinc-600 light:text-zinc-500">{label}</div>}
